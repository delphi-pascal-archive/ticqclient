...
type
  ...
  TOnPktParseAdv = procedure(Sender: TObject; Host: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean) of object;
  TOnHandlePkt = procedure(Flap: TFlapHdr; Buffer: Pointer) of object;
  TOnServerDisconnect = procedure(Sender: TObject; Reason: LongInt; Description: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object; // yegor
  TOnMsgProc = procedure(Sender: TObject; Msg, UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnWPagerProc = procedure(Sender: TObject; PSender,PEmail,PSenderIP, Msg:{$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;     // Added by Saif.N
  TOnOffMsgProc = procedure(Sender: TObject; DateTime: TDateTime; Msg, UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnURLProc = procedure(Sender: TObject; Description, URL, UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnOffURLProc = procedure(Sender: TObject; DateTime: TDateTime; Description, URL, UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnStatusChange = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Status: LongWord) of object;
  TOnOnlineInfo = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Port: Word; InternalIP, ExternalIP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  OnlineTime: TDateTime; IdleTime: Word; ICQVersion, MirandaVersion: LongWord; ProtoVer: Byte; UserCaps: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  AvatarId: Word; AvatarFlags: Byte; AvatarHash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  NewXStatusSet : Boolean; NewXStatusMoodNum : Byte; NewXStatusNote : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object; // yegor
  TOnUserEvent = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnUserGeneralInfo = procedure(Sender: TObject; UIN, NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip, Country: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  TimeZone: Byte; PublishEmail: Boolean) of object;
  TOnUserWorkInfo = procedure (Sender: TObject; UIN, WCity, WState, WPhone, WFax, WAddress, WZip, WCountry, WCompany, WDepartment, WPosition, WOccupation, WHomePage: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnUserInfoMore = procedure (Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Age: Word; Gender: Byte; HomePage: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BirthYear: Word; BirthMonth: Word; BirthDay: Word; Lang1, Lang2, Lang3: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnUserInfoAbout = procedure(Sender: TObject; UIN, About: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnUserInfoInterests = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Interests: TStringList) of object;
  TOnUserInfoMoreEmails = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Emails: TStringList) of object;
  TOnUserInfoBackground = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Pasts, Affiliations: TStringList) of object;
  TOnUserFound = procedure(Sender: TObject; UIN, Nick, FirstName, LastName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Status: Word; Gender, Age: Byte; SearchComplete: Boolean; Authorize: Boolean) of object;
  TOnServerListRecv = procedure(Sender: TObject; SrvContactList: TList) of object;
  TOnAdvMsgAck = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word; AcceptType: Byte; AcceptMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnMsgAck = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word) of object;
  TOnAutoMsgResponse = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word; RespStatus: Byte; Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnContactListRecv = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ContactList: TStringList) of object;
  TOnContactListReq = procedure(Sender: TObject; UIN, Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnDirectPktAck = procedure(Sender: TObject; ID: Word) of object;
  TOnSMSAck = procedure(Sender: TObject; Source, Network, MsgId: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Deliverable: Boolean) of object;
  TOnSMSReply = procedure(Sender: TObject; Source, SmsSender, Time, Text: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnInfoChanged = procedure(Sender: TObject; InfoType: TInfoType; ChangedOk: Boolean) of object;
  TOnAuthResponse = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Granted: Boolean; Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnChangeResponse = procedure(Sender: TObject; Id:Cardinal; ErrorCode: Word) of object;
  TOnUploadAvatarOk = procedure(Sender: TObject; AvatarId:Cardinal; Hash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  ...
  TOnUserInfoShort = procedure(Sender: TObject; UIN, NickName, FirstName, LastName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  UserFound, AuthRequired: Boolean) of object;
  TOnAuthRequest = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object;
  TOnICBMError = procedure(Sender: TObject; ErrorCode: Word) of object;
  TOnTypingNotification = procedure(Sender: TObject;  UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  NotificationType: Word) of object; //by ok3y
  TOnAvatarReceive = procedure(Sender: TObject; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  AvatarId: Word; AvatarFlags: Byte; AvatarHash, AvatarData, AvatarExt : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) of object; //by ok3y
  ...
  private
    ...
    FHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FHostViaHTTP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  // yegor
    FPortViaHTTP: Integer;
    FPort: Word;

    FProxyType: TProxyType;
    FProxyHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FProxyPort: Word;
    FProxyUser: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FProxyPass: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FProxyAuth: Boolean;
    ...
    FHTTPSid: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FHTTPIP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FHTTPPort: Word;
    FHTTPSeq: Word;
    ...
    procedure _OnError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    procedure _OnICQSocketThreadException(Sender: TObject; AExceptionStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
  ...
  public
    ...
    property Host: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FHost write FHost;
    property Port: Word read FPort write FPort;
    property HostViaHTTP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FHostViaHTTP write FHostViaHTTP; // yegor
    ...
    property ProxyHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyHost write FProxyHost;
    property ProxyPort: Word read FProxyPort write FProxyPort;
    property ProxyUser: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyUser write FProxyUser;
    property ProxyPass: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyPass write FProxyPass;
  ...
  private
    ...
    FLPass: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};                                      //Client's password
    ...
    FCookie: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};                                     //Temporary cookie, used in login sequence, we can use String type, becouse ICQ server doesn't send 0x00 chars in it's Cookie part
    FSSBICookie : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  // yegor                             //Host to connect to
    FHostViaHTTP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  // yegor                      //Host to connect to when HTTP proxy
    FPort: Word;                                        //Port to connect to
    FDConnCookie: LongWord;                             //Direct connection cookie
    FDirect: TDirectControl;                            //Direct control
    FAvatarFileName : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FAvatarId : Word;
    //-- Proxy settings
    FProxyType: TProxyType;                             //.
    FProxyHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};                                  //.
    ...
    FLastInfoUin: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FLastSInfoUin: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    FLoggedIn: Boolean;
    FRegisteringUIN: Boolean;
    FRegPassword: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    ...
    FAutoAwayMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    ...
    FLastError: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
    ...
    procedure OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    procedure FTOnPktParse(Sender: TObject; Host: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean);
    procedure OnFTInitProc(Sender: TObject; UIN: LongWord; FileCount, TotalBytes, Speed: LongWord; NickName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure OnFTStartProc(Sender: TObject; StartRec: TFTStartRec; FileName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  FileSize, Speed: LongWord);
    procedure OnFTFileDataProc(Sender: TObject; UIN: LongWord; Data: Pointer; DataLen: LongWord; LastPacket: Boolean);
    procedure FTOnSocketThreadException(Sender: TObject; AExceptionStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    procedure FOnExtServiseError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
  public
    ...
    procedure LogOff;
    procedure RegisterNewUIN(const Password: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure Disconnect;
    procedure SendMessage(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SendURL(UIN: LongWord; const URL, Description: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    procedure RequestAvatar(UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  AvatarId: Word; AvatarFlags: Byte; AvatarHash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure RequestInfo(UIN: LongWord);
    procedure RequestInfoShort(UIN: LongWord);
    procedure SearchByMail(const Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SearchByUIN(UIN: LongWord);
    procedure SearchByName(const FirstName, LastName, NickName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SearchRandom(Group: Word);
    procedure SearchWhitePages(const FirstName, LastName, NickName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  MinAge, MaxAge: Word; Gender: Byte; const Language, City, Country, Company, Department, Position, Occupation, Organization, OrganKeyWords, PastAffiliation, AffiKeyWords, KeyWord: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Online: Boolean);
    ...
    procedure SetSelfInfoGeneral(NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Country: Word; TimeZone: Byte; PublishEmail: Boolean);
    procedure SetSelfInfoMore(Age: Word; Gender: Byte; const HomePage: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BirthYear: Word; BirthMonth, BirthDay: Byte; Language1, Language2, Language3: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SetSelfInfoAbout(const About: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    procedure SendSMS(const Destination, Text: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SendMessageAdvanced(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word; RTFFormat: Boolean);
    procedure SendTypingNotification(UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  NotificationType: Word); //ok3y
    procedure SendYouWereAdded(UIN: LongWord);
    function SendMessageDirect(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  RTFFormat: Boolean): Word;
    Function SendFileDC(UIN:LongWord; FileName, Description:{$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Word;
    ...
    procedure SetNewXStatus(NewStat: T_NewXStatus; NewStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SetNewXStatusByICQMoodNum(ICQMoodNum: Byte; NewStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});

    procedure UpdateCapabilities;

    procedure MaskIntoQIP(BuildNum : LongWord);

    procedure UnregisterUIN(const Password: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    function  UploadAvatar(FileName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Word;
    function  DeleteAvatar(Id: Word): Boolean;
    procedure ChangePassword(const NewPassword: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    ...
    function RequestContacts(UIN: LongWord; const Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word): Boolean;
    function SendContactsDC(UIN: LongWord; Contacts: TStringList): Word;
    function RequestContactsDC(UIN: LongWord; const Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Word;
    procedure RequestExtService;
    procedure SendKeepAlive;
    procedure SendAuthRequest(UIN: LongWord; Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SendAuthResponse (aUIN: LongWord; aAuthorize: Boolean; aReason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
    procedure SSLActivate;  //added by Volkov Ioann
    procedure SSLChangeStart(FirstUpload: Boolean);
    procedure SSLChangeEnd;
    procedure SSLAddGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word);
    procedure SSLAddUser(GroupID, UserID: Word; UIN, Name, SMSNumber: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Authorize, UpdateUser: Boolean);
    procedure SSLDelUser(GroupID, UserID: Word; UIN, Name, SMSNumber: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Authorize: Boolean);
    procedure SSLDelGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word);
    procedure SSLUpdateGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word; UserIDs: TStringList);
    procedure SSLAddUserIntoList(UserID: Word; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BuddyType: Word);
    procedure SSLDelUserFromList(UserID: Word; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BuddyType: Word);
    function FTResponse(ResponseRec: TFTRequestRec; Accept: Boolean; Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Boolean;
    procedure FTCancel(UIN: LongWord);
    function FTStartResponse(StartRec: TFTStartRec): Boolean;
    property LastError: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FLastError;
  ...
  published
    ...
    property ProxyHost: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyHost write FProxyHost;
    property ProxyPort: Word read FProxyPort write FProxyPort;
    property ProxyUserID: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyUser write FProxyUser;
    property ProxyResolve: Boolean read FProxyResolve write FProxyResolve default False;
    property ProxyAuth: Boolean read FProxyAuth write FProxyAuth default False;
    property ProxyPass: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FProxyPass write FProxyPass;
    property SecureLogin: Boolean read FSecureLogin write FSecureLogin;
    property UIN: LongWord read FLUIN write FLUIN;
    property Password: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FLPass write FLPass;
    property ErrorLanguage: TICQLangType read FErrLang write SetErrorLang default LANG_EN;
    property ICQServer: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FHost write FHost; // yegor
    property ICQServerViaHTTP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FHostViaHTTP write FHostViaHTTP; // yegor
    ...
    property AutoAwayMessage: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}  read FAutoAwayMsg write FAutoAwayMsg;
...
procedure TICQNet._OnError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
...
begin
  if Sender = FSocket then begin
    ...
    {$IFDEF HTTP_DEBUG}
    LogText('http.txt', 'Received (send-proxy): '#13#10 + {$IFDEF VER230}PAnsiChar(Buffer){$ELSE}PChar(Buffer){$ENDIF});
    {$ENDIF}
    FCanSend := False;
    HTTPResend;
  end;
...
procedure TICQNet._OnICQSocketThreadException(Sender: TObject;
  AExceptionStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
  if Sender = FSocket then FreeSocket(FSendSocket) else FreeSocket(FSocket);
...
procedure TICQClient.OnIntError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
  FLastError := ErrorMsg;
  if Assigned(OnError) then
    FOnError(Self, ErrorType, ErrorMsg);
...
{Registers a new UIN.}
procedure TICQClient.RegisterNewUIN(const Password: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
...
procedure TICQClient.SendMessage(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendURL(UIN: LongWord; const URL, Description: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchByMail(const Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchByName(const FirstName, LastName, NickName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SearchWhitePages(const FirstName, LastName, NickName, Email: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  MinAge, MaxAge: Word;
  Gender: Byte; const Language, City, Country, Company, Department, Position, Occupation,
  Organization, OrganKeyWords, PastAffiliation, AffiKeyWords, KeyWord: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Online: Boolean);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoGeneral(NickName, FirstName, LastName, Email, City, State, Phone, Fax, Street, Cellular, Zip : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Country: Word; TimeZone: Byte; PublishEmail: Boolean);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoMore(Age: Word; Gender: Byte; const HomePage: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BirthYear: Word; BirthMonth, BirthDay: Byte; Language1, Language2, Language3: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetSelfInfoAbout(const About: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SendSMS(const Destination, Text: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendMessageAdvanced(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word; RTFFormat: Boolean);
var
  pkt: TRawPkt;
begin
...
procedure TICQClient.SendTypingNotification(UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
...
function TICQClient.SendMessageDirect(UIN: LongWord; const Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  RTFFormat: Boolean): Word;
var
  lpkt: TRawPkt;
begin
  Result := 0;
...
procedure TICQClient.UnregisterUIN(const Password: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.ChangePassword(const NewPassword: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
function TICQClient.RequestContacts(UIN: LongWord; const Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  ID: Word): Boolean;
var
  pkt: TRawPkt;
begin
  Result := False;
...
Function TICQClient.SendFileDC(UIN:LongWord; FileName, Description:{$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Word;
Var
  Pkt:TRawPkt;
...
function TICQClient.RequestContactsDC(UIN: LongWord; const Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Word;
var
  lpkt: TRawPkt;
begin
  Result := 0;
...
procedure TICQClient.SendAuthRequest(UIN: LongWord; Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQCLient.SendAuthResponse (aUIN: LongWord; aAuthorize: Boolean; aReason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
   Pkt: TRawPkt;
begin
     if not LoggedIn
...
{Add group to SSL.}
procedure TICQClient.SSLAddGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
{Add user to SSL.}
procedure TICQClient.SSLAddUser(GroupID, UserID: Word; UIN, Name, SMSNumber: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Authorize, UpdateUser: Boolean);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelUser(GroupID, UserID: Word; UIN, Name, SMSNumber: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Authorize: Boolean);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
{Update group's ids.}
procedure TICQClient.SSLUpdateGroup(GroupName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  GroupID: Word; UserIDs: TStringList);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLAddUserIntoList(UserID: Word; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BuddyType: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
procedure TICQClient.SSLDelUserFromList(UserID: Word; UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  BuddyType: Word);
var
  lpkt: TRawPkt;
begin
  if (not LoggedIn) then Exit;
...
function TICQClient.FTResponse(ResponseRec: TFTRequestRec; Accept: Boolean; Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}): Boolean;
var
  lpkt: TRawPkt;
begin
...
var
  FUIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FData, FIpPort, FValue: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  pkt: TRawPkt;
  T: Word;
  Snac: TSnacHdr;
  i, Cnt: Word;
  ...
  SSBIHost, SSBIPort: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FHandle, FLength : Integer;
  FBuffer: {$IFDEF VER230}PAnsiChar{$ELSE}PChar{$ENDIF};
  Hash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  HashSize: Byte;
begin
  case Flap.ChID of
    1: //Channel 1
                ...
                begin
                  ...
                  begin
                    ...
                    try
					  ...
					  {$IFDEF VER230}
                      FBuffer := PAnsiChar(AllocMem(FLength + 1));
					  {$ELSE}
...
var
  ...
  Msg, UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  MsgType: Word;
  MsgFlag: Byte;
  Answer: LongInt;
  aPort:Word;
  ...
  extIP: DWORD;
  wAck: Word;
  Desc, URL: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  v: Byte;
  atype: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  XML: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  XMLTime, XMLSource, XMLSender, XMLText: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FName, FDesc: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FSize: LongWord;
  FFSeq, FFSeq2: Word;
  Rec: TFTRequestRec;
  TCMD: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  List: TStringList;
  PSender, PEmail, PSenderIP: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  Request: Boolean;
  TlvType:Word;
  TlvCount: Word;
begin
...
var
  ...
  FLang1, FLang2, FLang3, FAbout: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FTimeZone: Byte;
  FPublishEmail: Boolean;
  FAge, FYear: Word;
  FGender, FMonth, FDay: Byte;
  Msg, UIN, URL, Desc: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  ...
  cmd: Word;
  seq: Word;
  FSmsSource, FSmsDeliverable, FSmsNetwork, FMsgId: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FAuthorize: Byte;
...
procedure TICQClient.HSnac030B(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
  function NumToIp(Addr: LongWord): {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  var
    inaddr: in_addr;
  begin
    inaddr.S_addr := Addr;
...
var
  c, i: Word;
  UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  Status: LongWord;
  ...
  FProtoVer: Word;
  UserCaps: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  TimeStamp: LongInt;
  TimeUnk: TDateTime;
  ...
  AvatarId: Word;
  AvatarFlags: Byte;
  AvatarHash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  NewXStatusSet : Boolean;
  NewXStatusMoodNum : -1..100;
  NewXStatusNote, tlvDat, tmpStr : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
...
var
  FUin: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FReason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
begin
  Inc(Pkt^.Len, 8);
  FUin := GetLStr(Pkt);
...
var
  RetCode: Word;
  RetAcc: Byte;
  RetMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  MsgType: Byte;
  FUIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
begin
  Inc(Pkt^.Len, 4);                     //Time
...
var
  T: Word;
  UIN, Reason: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  Granted: Boolean;
begin
...
var
  Msg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  lpkt: TRawPkt;
  LSeq: Word;
  cmd, scmd: Word;
  S, Desc, URL: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  List: TStringList;
  FText: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  FileLen: LongWord;
  Port: Word;
  rec: TFTRequestRec;
begin
...
procedure TICQClient.FTOnPktParse(Sender: TObject; Host: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  Port: Word; Buffer: Pointer; BufLen: LongWord; Incoming: Boolean);
begin
  if Assigned(OnPktParse) then
    FOnPktParse(Self, TICQNet(Sender).Host, TICQNet(Sender).Port, Buffer, BufLen, Incoming);
end;

procedure TICQClient.OnFTInitProc(Sender: TObject; UIN: LongWord; FileCount, TotalBytes, Speed: LongWord; NickName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
  if Assigned(OnFTInit) then
    FOnFTInit(Self, UIN, FileCount, TotalBytes, Speed, NickName);
end;

procedure TICQClient.OnFTStartProc(Sender: TObject; StartRec: TFTStartRec; FileName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  FileSize, Speed: LongWord);
begin
...
function DigestToBuff(Digest: Md5Digest): {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
var
  I: Integer;
begin
...
var
  KeyLen: Word;
  Key: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  State: Md5Context;
  Digest: MD5Digest;
  answ_pkt: TRawPkt;
  pwdbuff: array[0..15] of byte;
  pwd: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  i:integer;
begin
  KeyLen := GetInt(Pkt, 2);
...
function DetectAvatarFormat(AvatarData: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) : TAvatarFormat;
begin
...
var
  ...
  AvatarFlags : Byte;
  AvatarHash : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  AvatarData : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
  AvatarExt : {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};
//  i: Integer;
begin
  try
    UIN := GetLStr(Pkt);
...
procedure TICQClient.FOnExtServiseError(Sender: TObject; ErrorType: TErrorType; ErrorMsg: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
begin
  FExtServiceReady := False;
  Sleep(50);
  RequestExtService;
...
procedure TICQClient.RequestAvatar(UIN: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF};  AvatarId: Word;
  AvatarFlags: Byte; AvatarHash: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
...
function TICQClient.UploadAvatar(FileName: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF}) : Word;
var
  pkt: TRawPkt;
  TLVs: TRawPkt;
  h : Md5Digest;
...
procedure TICQClient.SetNewXStatus(NewStat: T_NewXStatus; NewStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure TICQClient.SetNewXStatusByICQMoodNum(ICQMoodNum: Byte; NewStr: {$IFDEF VER230}RawByteString{$ELSE}string{$ENDIF});
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
...
procedure Register;
begin
  RegisterComponents('ICQClient', [TICQClient]);
end;
